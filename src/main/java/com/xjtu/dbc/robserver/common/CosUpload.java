...
public class CosUpload {
    ...
    public String SimpleUploadFileFromLocal(File fileInputStream, String name) {
        String etag = "https://note-image-1307786938.cos.ap-beijing.myqcloud.com";
        // 1 初始化用户身份信息(secretId, secretKey)
        COSCredentials cred = new BasicCOSCredentials("AKIDpTt40g7JFwNZVCdvylJbdQxEH8l8G9mA", "B9sNddOt88tQhrlPoxtZ0B7nDNIyOZUE");
        // 2 设置bucket的区域
        ClientConfig clientConfig = new ClientConfig(new Region("ap-beijing"));
        // 3 生成cos客户端
        COSClient cosclient = new COSClient(cred, clientConfig);
        // bucket名需包含appid
        String bucketName = "note-image-1307786938";
        String key = "/img/" + name;
